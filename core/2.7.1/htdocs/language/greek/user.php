...
define('_US_EMAIL', 'Ηλ. Ταχυδρομείο');
...
define('_US_SORRYNOTFOUND', 'Εάν υπάρχει λογαριασμός που αντιστοιχεί στις παρεχόμενες πληροφορίες, θα επεξεργαστούμε το αίτημά σας. Αν δεν λάβετε σύντομα email, ελέγξτε τον φάκελο ανεπιθύμητης αλληλογραφίας (spam) ή επικοινωνήστε με τον διαχειριστή του ιστότοπου.');
...
define('_US_PWDMAILED', 'Εάν υπάρχει λογαριασμός για αυτό το email, θα λάβετε οδηγίες για επαναφορά κωδικού πρόσβασης. Ελέγξτε τον φάκελο spam αν χρειάζεται ή επικοινωνήστε με τον διαχειριστή του ιστότοπου.');
define('_US_PWDRESETDONE', 'Ο κωδικός πρόσβασής σας άλλαξε επιτυχώς. Μπορείτε πλέον να συνδεθείτε με τον νέο σας κωδικό.');
define('_US_CONFMAIL', 'Εάν υπάρχει λογαριασμός για αυτό το email, θα λάβετε οδηγίες για επαναφορά κωδικού πρόσβασης. Ελέγξτε τον φάκελο spam αν χρειάζεται ή επικοινωνήστε με τον διαχειριστή του ιστότοπου.');
...
define('_US_PWDEQUALSUNAME', 'Ο κωδικός πρόσβασής σας δεν μπορεί να είναι ίδιος με το όνομα χρήστη σας.');
...
define('_US_WELCOME_SUBJECT', 'Καλώς ήρθατε στο %s');

//XOOPS 2.5.4
define('_US_SKYPE', 'Skype');
define('_US_FACEBOOK', 'Facebook');
//XOOPS 2.5.9
define('_US_USERALREADYACTIVE', 'Ο χρήστης είναι ήδη ενεργός');
//XOOPS 2.5.11
define('_US_DESCRIPTIONMIN', 'Ελάχιστο απαιτούμενο μήκος: %s');
define('_US_DESCRIPTIONMAX', 'Μέγιστο μήκος: %s');

//2.7.1 backfilled translations
define('_US_PM', 'PM');
//define('_US_USECOOKIE', 'Αποθήκευση του ονόματος χρήστη μου σε cookie για 1 έτος');
