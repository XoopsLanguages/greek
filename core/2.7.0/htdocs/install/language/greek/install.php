...
define('MODULES_AVAILABLE', 'Διαθέσιμες ενότητες');
define('INSTALL_THIS_MODULE', 'Προσθήκη %s');
//2.5.11
define('ERR_COPY_CONFIG_FILE', 'Δεν ήταν δυνατή η αντιγραφή του αρχείου διαμόρφωσης %s');
//2.7.0
// website name and slogan
define('_WEBSITE_NAME', 'XOOPS Ιστότοπος');
define('_WEBSITE_SLOGAN', 'Απλά χρησιμοποιήστε το!');
define('_WEBSITE_META_KEYWORDS', 'xoops, πλαίσιο εφαρμογών ιστού, cms, σύστημα διαχείρισης περιεχομένου');
define('_WEBSITE_FOOTER', "Με την υποστήριξη XOOPS © 2001-{X_YEAR} <a href='https://xoops.org' rel='external' title='The XOOPS Project'>The XOOPS Project</a>");
define('_WEBSITE_COPYRIGHT', 'Πνευματικά δικαιώματα © 2001-{X_YEAR}');
define('_WEBSITE_DESCRIPTION', 'Το XOOPS είναι ένα δυναμικό σενάριο πύλης ανοιχτού κώδικα βασισμένο σε αντικειμενοστραφή και γραμμένο σε PHP.');
define('_WEBSITE_CENSOR_REPLACE', 'ΟΥΠΣ');
