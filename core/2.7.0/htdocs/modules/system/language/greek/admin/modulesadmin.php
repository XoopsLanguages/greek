...
define('_AM_SYSTEM_MODULES_MODULE', 'Ενότητα');
...
define('_AM_SYSTEM_MODULES_ACCESS_USER_ADD', 'Προστέθηκε δικαίωμα πρόσβασης χρήστη για το ID Ομάδας: %s');
define('_AM_SYSTEM_MODULES_ACCESS_USER_ADD_ERROR', 'ΣΦΑΛΜΑ: Δεν ήταν δυνατή η προσθήκη δικαιώματος πρόσβασης χρήστη για το ID Ομάδας: %s');
...
// 2.7.0
define('_AM_SYSTEM_MODULES_FK_DISABLE', 'Αποτυχία απενεργοποίησης ελέγχων ξένων κλειδιών');
define('_AM_SYSTEM_MODULES_FK_ENABLE', 'Αποτυχία ενεργοποίησης ελέγχων ξένων κλειδιών');
define('_AM_SYSTEM_MODULES_DROP_FAIL', 'Απέτυχε η απόθεση του πίνακα: %s');
define('_AM_SYSTEM_MODULES_DROP_OK', 'Πτώση πίνακα: %s');
