...
define('_XOOPS_SMARTY4_SCANNER_AUTOFIX', 'Μπορεί να διορθωθεί αυτόματα: για κάθε μεταβλητή στοιχείου θα μετονομαστεί προσθέτοντας "_item" (π.χ. το "foo" γίνεται "foo_item").');
...
define(
    ...
    <<<'EOT'
<h3>XOOPS 2.7.0 εισάγει μια σημαντική αλλαγή: Smarty 4</h3>

<p>Δυστυχώς, αυτή η αλλαγή ενδέχεται να διαταράξει ορισμένα παλαιότερα θέματα. Επομένως, προτού προχωρήσετε στην αναβάθμιση, βεβαιωθείτε ότι ακολουθείτε τα εξής βήματα:

<li>Εκτελέστε preflight.php για να ελέγξετε για τυχόν παλιά θέματα ή πρότυπα λειτουργικών μονάδων.</li>
<li>Εάν εντοπιστούν προβλήματα, συμβουλευτείτε αυτό το έγγραφο για να κατανοήσετε τις απαραίτητες τροποποιήσεις πριν προχωρήσετε στην αναβάθμιση.</li>
<li>Αφού κάνετε τις απαιτούμενες αλλαγές, εκτελέστε ξανά το preflight.php.</li>
<li>Εάν δεν υπάρχουν άλλα προβλήματα, μπορείτε να ξεκινήσετε τη διαδικασία αναβάθμισης.</li>
</p>
EOT,
);
