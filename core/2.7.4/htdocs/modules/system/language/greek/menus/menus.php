...
define('MENUS_HOME', 'Αρχική');
define('MENUS_ADMIN', 'Διαχείριση');
define('MENUS_ACCOUNT', 'Λογαριασμός');
define('MENUS_ACCOUNT_EDIT', 'Επεξεργασία λογαριασμού');
define('MENUS_ACCOUNT_LOGIN', 'Σύνδεση');
define('MENUS_ACCOUNT_LOGOUT', 'Αποσύνδεση');
define('MENUS_ACCOUNT_REGISTER', 'Εγγραφή');
define('MENUS_ACCOUNT_MESSAGES', 'Μηνύματα');
define('MENUS_ACCOUNT_NOTIFICATIONS', 'Ειδοποιήσεις');
define('MENUS_ACCOUNT_TOOLBAR', 'Γραμμή εργαλείων');
